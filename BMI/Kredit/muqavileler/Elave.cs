...
namespace BMI
{
    public partial class Elave_Zamin : Form
    {
        public Elave_Zamin()
        {
            InitializeComponent();
        ...
        private void meknoal()
        {
            ...
            Orcom = new OracleCommand("insert into odb.xaric_mektub x (x.gon_yer, x.tarix, x.qisa_mez, x.icraci,  x.il) values ('" + aray_ad .Text+ "', TO_DATE('" + dateavtoMuqtarix.Text + "','dd-MM-yyyy'), 'zamin xitam', '" + icraci_kod + "',  " + tarixIl + ")", Orcon);
        ...
        private void word_at()
        {
            ...
            //if (!System.IO.File.Exists(Application.StartupPath + "\\Elave zamin deyisme BIR.docx.docx"))
            //{
            ...
            var Muqtarix = tarix_soz;
            var muqilkintar = tarix_sozilkintarix;
            var temsay = teminatsay;
            var arad = aray_ad.Text;
            var arNo = arayNo.Text;
            ...
            var zam1pastarixi = txbzam1pastar.Text;
            ...
            if (comboBox1.Text=="İki nəfərin zəmanəti")
            {
                yol = "\\Elave zamin deyisme İKİ.docx";
            }
            else
            {
                yol = "\\Elave zamin deyisme BIR.docx";
            }
            ...
            ReplaceWordStub("{arNosu}", arNo, wordDocument);
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox1.Checked == true)
            {
                ...
                textBox5.Text = txbzmuqtar.Text;
                arayisad = aray_ad.Text;
                arayisNo = arayNo.Text;
        ...
        private void Elave_Zamin_Load(object sender, EventArgs e)
        {
            string adhazir;
            string unvanhazir;
            adhazir = txbzBorcalan.Text.ToLower();
